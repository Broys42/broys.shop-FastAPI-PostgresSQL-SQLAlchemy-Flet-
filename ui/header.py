...
class HeaderInMainPage(ft.Stack):
...
class HeaderOutsideMainPage(ft.Stack):
    def __init__(self, page: ft.Page):
        super().__init__()
        self.height = 50
        self.page = page
        ...
        self.go_to_main_page_button = ft.Container(
            content=ft.Text(
                value="На главную",
                weight=ft.FontWeight.BOLD,
            )
        ...
        self.controls = [
            self.not_transparent_background_color,
            self.header_buttons
        ]
